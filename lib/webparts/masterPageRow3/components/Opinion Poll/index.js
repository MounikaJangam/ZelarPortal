...
var OpinionPoll = function (props) {
    ...
    var _c = React.useState(false), createformmode = _c[0], setCreateformmode = _c[1];
    var _d = React.useState(false), canCreate = _d[0], setcanCreate = _d[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'rowMain3' },
            ...
            React.createElement("div", { className: 'row32' },
                canCreate &&
                    React.createElement(AiFillPlusCircle, { className: createformmode ? "formBtnOpened" : "formBtn", onClick: function () { return setCreateformmode(!createformmode); }, size: 40 }),
